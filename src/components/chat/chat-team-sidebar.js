function ChatTeamSidebar({ team }) {
  return (
    <section className="team-sidebar h-full bg-indigo-800 min-h-screen text-purple-300 flex-none md:w-64 sm:w-48 pb-6 flex flex-col">
...
export default ChatTeamSidebar;
