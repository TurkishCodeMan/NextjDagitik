      ...
      <main>
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://images.unsplash.com/photo-1576091160550-2173dba999ef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80)",
            }}
          >
            <span
              id="blackOverlay"
        ...
        <section className="pb-20 bg-blueGray-200 -mt-24">
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap">
              {isLoading && <CircleLoader className="flex items-center justify-center w-full"/>}
              {posts.posts &&
                posts.posts
                  ...
                  .map((post, index) => (
                    <Link key={post._id} href={`/blogs/${post.slug}`}>
                      <div
                        className={`lg:pt-12 cursor-pointer  pt-6 w-full md:w-4/12 px-4 text-center ${
                          index !== 1 ? "mt-12" : ""
                        }`}
                      >
                        <div className="relative flex flex-col min-w-0 break-words bg-white bg-opacity-60 w-full mb-8 shadow-lg rounded-lg">
                          <div className="px-4 py-5 flex-auto">
                            <div className="text-white p-3 text-center inline-flex items-center justify-center mb-5 shadow-lg rounded-full bg-red-400">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <Link href="/a" className="font-bold text-blueGray-700 mt-8">
                  <a> Check Notus React!</a>
                </Link>
              </div>
